...
procedure part_1 is
    ...
    function Check_Fully_Overlapping_Sections (This : VString) return Boolean;

    function Check_Fully_Overlapping_Sections (This : VString) return Boolean is
    ...
    begin
        ...
        if ( ( R1 <= R3 and R2 >= R4 ) or ( R3 <= R1 and R4 >= R2 ) ) then
            Overlapping := True;
        end if;
        ...
        return Overlapping;
    end Check_Fully_Overlapping_Sections;
...
begin
    ...
    loop
        ...
        Overlap_temp := Check_Fully_Overlapping_Sections(Line_temp);
